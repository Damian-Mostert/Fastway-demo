...
function TrackingForm(){
	...
	const {post,processing,setData:setFormValues} = useForm();
    ...
    return <form className="flex flex-col w-full" onSubmit={(ev)=>{
        ...
        <div className="grid gap-6">
            <h2 className='text-3xl font-semibold text-center'>Track and Trace a Parcel</h2>
...
function QuoteForm(){
    ...
    return <form className="flex flex-col w-full" onSubmit={(ev)=>{
        ...
        <div className="grid gap-6">
            <h2 className='text-3xl font-semibold text-center'>Get a Quote for Sending a Parcel</h2>
            <div className="grid gap-2">
